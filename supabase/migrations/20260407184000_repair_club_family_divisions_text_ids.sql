DO $$
BEGIN
    IF to_regclass('public.club_family_divisions') IS NULL THEN
        CREATE TABLE public.club_family_divisions (
    ...
    ELSE
        ALTER TABLE public.club_family_divisions
            DROP CONSTRAINT IF EXISTS club_family_divisions_family_base_club_id_fkey,
            DROP CONSTRAINT IF EXISTS club_family_divisions_roster_owner_club_id_fkey,
            DROP CONSTRAINT IF EXISTS club_family_divisions_division_club_id_fkey,
            DROP CONSTRAINT IF EXISTS club_family_divisions_pk,
            DROP CONSTRAINT IF EXISTS club_family_divisions_distinct;

        ALTER TABLE public.club_family_divisions
            ALTER COLUMN family_base_club_id TYPE TEXT USING family_base_club_id::TEXT,
            ALTER COLUMN roster_owner_club_id TYPE TEXT USING roster_owner_club_id::TEXT,
            ALTER COLUMN division_club_id TYPE TEXT USING division_club_id::TEXT;
        ...
        ALTER TABLE public.club_family_divisions
            ALTER COLUMN family_base_club_id SET NOT NULL,
            ALTER COLUMN roster_owner_club_id SET NOT NULL,
            ALTER COLUMN division_club_id SET NOT NULL,
            ALTER COLUMN created_at SET DEFAULT NOW(),
            ALTER COLUMN updated_at SET DEFAULT NOW();

        ALTER TABLE public.club_family_divisions
            ADD CONSTRAINT club_family_divisions_pk PRIMARY KEY (family_base_club_id, division_club_id),
            ADD CONSTRAINT club_family_divisions_distinct CHECK (roster_owner_club_id <> division_club_id),
            ADD CONSTRAINT club_family_divisions_family_base_club_id_fkey
                FOREIGN KEY (family_base_club_id) REFERENCES public.clubs(id) ON DELETE CASCADE,
            ADD CONSTRAINT club_family_divisions_roster_owner_club_id_fkey
                FOREIGN KEY (roster_owner_club_id) REFERENCES public.clubs(id) ON DELETE CASCADE,
            ADD CONSTRAINT club_family_divisions_division_club_id_fkey
                FOREIGN KEY (division_club_id) REFERENCES public.clubs(id) ON DELETE CASCADE;
    END IF;
END $$;
