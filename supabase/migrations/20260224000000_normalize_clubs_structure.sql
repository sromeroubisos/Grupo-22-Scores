-- ============================================================
-- MIGRATION: Normalize Clubs Structure (Professional Design)
-- Fecha: 2026-02-24
-- Descripción: Separa clubs en capas (core vs profile vs arrays)
--              para evitar pisar datos existentes en UPDATE
-- ============================================================
