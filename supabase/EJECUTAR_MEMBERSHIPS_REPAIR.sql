-- =============================================================================
-- EJECUTAR EN: https://supabase.com/dashboard/project/vxsolicapdcpemfsahbk/sql/new
-- Crea/rehace la tabla public.memberships y deja RLS funcional.
-- =============================================================================
...
-- Verificacion rapida
SELECT to_regclass('public.memberships') AS memberships_table;
