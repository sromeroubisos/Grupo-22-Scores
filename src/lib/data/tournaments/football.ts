...
export const FOOTBALL_TOURNAMENTS_INTERNATIONAL: Tournament[] = [
    ...
    // South America
    { id: 'fb-copa-am', name: 'Copa América', url: '/football/south-america/copa-america/', type: 'international', sportId: 'football', countryId: 'south-america', priority: 98, categories: ['men'] },
    { id: 'fb-lib', name: 'Copa Libertadores', url: '/football/south-america/copa-libertadores/', type: 'international', sportId: 'football', countryId: 'south-america', priority: 100, categories: ['men'] },
    { id: 'fb-sud', name: 'Copa Sudamericana', url: '/football/south-america/copa-sudamericana/', type: 'international', sportId: 'football', countryId: 'south-america', priority: 92, categories: ['men'] },
...
export const FOOTBALL_TOURNAMENTS_BY_COUNTRY: Record<string, Tournament[]> = {
    ...
    'argentina': [
        { id: 'fb-arg-lp', name: 'Liga Profesional', url: '/football/argentina/liga-profesional/', type: 'local', sportId: 'football', countryId: 'argentina', priority: 100, categories: ['men'] },
        { id: 'fb-arg-clp', name: 'Copa de la Liga Profesional', url: '/football/argentina/copa-de-la-liga-profesional/', type: 'cup', sportId: 'football', countryId: 'argentina', priority: 95, categories: ['men'] },
        ...
        { id: 'fb-arg-ca', name: 'Copa Argentina', url: '/football/argentina/copa-argentina/', type: 'cup', sportId: 'football', countryId: 'argentina', priority: 90, categories: ['men'] },
