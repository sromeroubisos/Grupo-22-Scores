...
const LINEUPS: LineupsData = {
    ...
    homeTeam: {
        ...
        starters: [
            { number: 1, name: 'Nicolas Revol Pitt', rating: 7.4 },
            { number: 2, name: 'Juan Ignacio Greising Revol', rating: 6.8 },
            { number: 3, name: 'Ignacio Sosa', rating: 5.9 },
            { number: 4, name: 'Rodrigo Fernandez Criado', rating: 8.1 },
            { number: 5, name: 'Tomas Bengoechea', rating: 7.7 },
            { number: 6, name: 'Facundo Miranda', rating: 6.2 },
            { number: 7, name: 'Santiago Peralta', rating: 9.3 },
            { number: 8, name: 'Lucas Arrieta', isCaptain: true, rating: 8.6 },
            { number: 9, name: 'Nicolas Vera', rating: 4.8 },
            { number: 10, name: 'Joaquin Blanco', rating: 7.1 },
            { number: 11, name: 'Emiliano Diaz', rating: 6.5 },
            { number: 12, name: 'Martin Ocampo', rating: 10 },
            { number: 13, name: 'Franco Ledesma', rating: 7.9 },
            { number: 14, name: 'Agustin Rios', rating: 3.4 },
            { number: 15, name: 'Pedro Solano', rating: 8.8 },
            { number: 16, name: 'Gonzalo Prieto', rating: 6.9 },
            { number: 17, name: 'Ramiro Cardozo', rating: 7.2 },
            { number: 18, name: 'Ivan Barrios', rating: 8.3 },
            { number: 19, name: 'Bruno Ferrero', rating: 6.1 },
            { number: 20, name: 'Julian Riquelme', rating: 7.5 },
            { number: 21, name: 'Mateo Alvarez', rating: 5.2 },
            { number: 22, name: 'Tomas Iriarte', rating: 6.7 },
            { number: 23, name: 'Simon Etcheverry', rating: 7.3 },
        ],
    },
    awayTeam: {
        name: 'Northland',
        ...
        starters: [
            { number: 1, name: 'Diego Ferreyra', rating: 7.4 },
            { number: 2, name: 'Hernan Quiroga', rating: 6.8 },
            { number: 3, name: 'Leandro Bustos', rating: 5.9 },
            { number: 4, name: 'Matias Correa', rating: 8.1 },
            { number: 5, name: 'Rodrigo Nunez', rating: 7.7 },
            { number: 6, name: 'Alejo Medina', rating: 6.2 },
            { number: 7, name: 'Damian Torres', isCaptain: true, rating: 9.3 },
            { number: 8, name: 'Cristian Vidal', rating: 8.6 },
            { number: 9, name: 'Lautaro Gimenez', rating: 4.8 },
            { number: 10, name: 'Sebastian Roldan', rating: 7.1 },
            { number: 11, name: 'Manuel Aguirre', rating: 6.5 },
            { number: 12, name: 'Federico Zarate', rating: 10 },
            { number: 13, name: 'Valentin Godoy', rating: 7.9 },
            { number: 14, name: 'Thiago Ponce', rating: 3.4 },
            { number: 15, name: 'Bautista Cabral', rating: 8.8 },
            { number: 16, name: 'Ezequiel Maidana', rating: 6.9 },
            { number: 17, name: 'Marcos Ibarra', rating: 7.2 },
            { number: 18, name: 'Joaquin Sarmiento', rating: 6.4 },
            { number: 19, name: 'Nahuel Paredes', rating: 8.2 },
            { number: 20, name: 'Ramiro Escobar', rating: 5.6 },
            { number: 21, name: 'Benjamin Castro', rating: 7.6 },
            { number: 22, name: 'Tobias Leguizamon', rating: 6.3 },
            { number: 23, name: 'Ignacio Villanueva', rating: 9.1 },
        ],
    },
};
