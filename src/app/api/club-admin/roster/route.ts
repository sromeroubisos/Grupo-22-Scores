...
export async function POST(request: NextRequest) {
    ...
    const result = await addPersonToClub(clubId, {
        ...
        doc_country: typeof body?.doc_country === 'string' ? body.doc_country : undefined,
        front_row_certified: typeof body?.front_row_certified === 'boolean' ? body.front_row_certified : undefined,
