...
const TEAM_METRIC_KEYS: TeamMetricKey[] = [
    ...
    'steals',
    'turnoversBadPass',
    'turnoversOffensiveFoul',
    'turnoversTechnicalFault',
    'turnoversPassivePlay',
    'twoMinSuspensions',
    'blueCards',
    'touchdowns',
    'touchdownsRushing',
...
function createEmptyAggregatedStats(): CompleteMatchStats {
    ...
    return {
        ...
        greenCards: zero(),
        penaltyCorners: zero(),
        penaltyCornerGoals: zero(),
        penaltyStrokes: zero(),
        penaltyStrokeGoals: zero(),
        penaltyStrokesSaved: zero(),
        freeHits: zero(),
        assists: zero(),
        shotsOnGoal: zero(),
        shotsOffTarget: zero(),
        ...
        goalsEmptyNet: zero(),
        sevenMeters: zero(),
        sevenMeterGoals: zero(),
        sevenMetersSaved: zero(),
        shotsSaved: zero(),
        shotsMissed: zero(),
        shotsBlocked: zero(),
        savesSevenMeter: zero(),
        steals: zero(),
        turnoversBadPass: zero(),
        turnoversOffensiveFoul: zero(),
        turnoversTechnicalFault: zero(),
        turnoversPassivePlay: zero(),
        twoMinSuspensions: zero(),
        blueCards: zero(),
        touchdowns: zero(),
        touchdownsRushing: zero(),
        touchdownsPassing: zero(),
        touchdownsDefensive: zero(),
        touchdownsReturn: zero(),
        fieldGoals: zero(),
        fieldGoalAttempts: zero(),
        fieldGoalsBlocked: zero(),
        extraPoints: zero(),
        ...
        fumbles: zero(),
        fumblesLost: zero(),
        fumbleRecoveries: zero(),
        turnoversOnDowns: zero(),
        turnovers: zero(),
        punts: zero(),
        kickoffs: zero(),
        touchbacks: zero(),
