                ...
                <div className="app-container">
                    ...
                    <header className="page-header">
                        <div className="title-area">
                            <div className="breadcrumb">Panel / Torneos / <span>Crear torneo</span></div>
                            <h1>Crear torneo</h1>
                            <p>Configurá lo básico y lo publicás cuando quieras.</p>
                        </div>
                        <div className="header-actions">
                            <div className="status-chip">Borrador</div>
                    ...
                    <main className="wizard-content">
                        ...
                        <footer className="wizard-footer">
                            ...
                            <div style={{ display: 'flex', gap: '12px' }}>
                                ...
                                >
                                    {currentStep === 5 ? 'Publicar Torneo' : 'Siguiente'}
                                </button>
                            </div>
                        </footer>
                    </main>
