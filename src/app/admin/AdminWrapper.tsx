...
export default function AdminWrapper({ children }: { children: React.ReactNode }) {
    ...
    const isAllowed = user && ['admin_general', 'admin_union', 'admin_torneo', 'operador'].includes(user.role);
    ...
    return (
        <div className="flex w-full min-h-screen bg-background text-foreground">
            {!isMatchConsole && !isTournamentAdmin && !isUnionAdmin && !isDiscipline && <Sidebar />}
